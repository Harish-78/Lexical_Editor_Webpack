...
import { useDebounce } from '../CodeActionMenuPlugin/utils.ts'
...
function TableHoverActionsContainer({
  ...
  return (
    <>
      {isShownRow && (
        <button
          className={'aroopa_editor__tableAddRows'}
          style={{ ...position }}
      ...
      {isShownColumn && (
        <button
          className={'aroopa_editor__tableAddColumns'}
          style={{ ...position }}
...
function getMouseInfo(event: MouseEvent): {
  ...
  if (target && target instanceof HTMLElement) {
    const tableDOMNode = target.closest<HTMLElement>(
      'td.aroopa_editor__tableCell, th.aroopa_editor__tableCell'
    )

    const isOutside = !(
      tableDOMNode ||
      target.closest<HTMLElement>('button.aroopa_editor__tableAddRows') ||
      target.closest<HTMLElement>('button.aroopa_editor__tableAddColumns') ||
