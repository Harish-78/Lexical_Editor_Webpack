...
import { CAN_USE_DOM as CAN_USE_DOM_ } from '../../shared/canUseDOM.ts'
import {
...
import normalizeClassNames from '../../shared/normalizeClassNames.ts'

export { default as markSelection } from './markSelection.ts'
export { default as mergeRegister } from './mergeRegister.ts'
export { default as positionNodeOnRange } from './positionNodeOnRange.ts'
export {
  $splitNode,
  isBlockDomNode,
  isHTMLAnchorElement,
