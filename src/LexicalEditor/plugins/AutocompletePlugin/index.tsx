...
import {
  ...
  AutocompleteNode,
} from '../../nodes/AutocompleteNode.tsx'
import { addSwipeRightListener } from '../../utils/swipe.ts'
    ...
    function handleUpdate() {
      editor.update(() => {
        ...
        searchPromise.promise
          .then(async (newSuggestion) => {
            if (searchPromise !== null) {
              await updateAsyncSuggestion(searchPromise, newSuggestion)
            }
          })
          .catch((e) => {
            // console.log({ e });
