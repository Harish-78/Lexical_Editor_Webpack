...
import { $isCodeNode, CODE_LANGUAGE_MAP } from '../../nodes/CodeNode/index.ts'
...
export default function LandingPageToolbarPlugin({
  setIsLinkEditMode,
  defaultStyles,
}: {
  ...
  const [fontSize, setFontSize] = useState<string>(
    defaultStyles?.fontSize ? defaultStyles?.fontSize : '14px'
  )
  const [fontColor, setFontColor] = useState<string>('#000')
  const [bgColor, setBgColor] = useState<string>('#fff')
  const [fontFamily, setFontFamily] = useState<string>(
    defaultStyles?.fontFamily ? defaultStyles?.fontFamily : 'Arial'
  )
  ...
  return (
    <div className="toolbar">
      ...
      <>
        ...
        <button
          className={
            'toolbar-item spaced ' + dropDownActiveClass(blockType === 'bullet')
          }
        ...
        <button
          className={
            'toolbar-item spaced ' + dropDownActiveClass(blockType === 'number')
          }
